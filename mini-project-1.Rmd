...
<!-------------------------- Start your work below ---------------------------->
I am choosing to work with the apt_buildings data set because I feel that it is the most diverse data set. The other datasets I was interested in were heavily numeric or categorical data, whereas I feel the apt_buildings data set has the most numeric variables while having many interesting categorical variables. I think this will lead to more interesting investigations of the data. 
...
<!-------------------------- Start your work below ---------------------------->
_Is there a relationship between the age of the apartment building and other variables?_
<!----------------------------------------------------------------------------->
...
<!-------------------------- Start your work below ---------------------------->
1. There are many numeric variables to plot. I can plot the distribution of apartment buildings with different #s of floors, units, or buildings constructed by decade.
```{r}
...
4. I am interested to see if buildings built in a certain year will have certain amenities such as an elevator, garbage chute, underground parking etc. Exploring this relationship relates to my first research question and is important to investigate. Q: Does the age of the building affect the # of non-smoking buildings
```{r}
#
...
#Correlation between year built and # non smoking buildings

```


5.I could filter buildings that fit a certain criteria (ex, features I would 'NEED' in an apartment) to see how many units fit that description.
```{r}
...
7.I could easily subset for apartment qualities I am interested in and subtract redundant columns (ex, columns where every apartment fulfills the requirement such as hot water + fire alarms). This will help me look at the differences in the data set rather than obvious similiarities. Since I already filtered for my requirements in an apartment, I want to see the listing # and address info for the available units.
...
2. Can this dataset be used to determine "safe" buildings (in terms of engineering + admin controls)?
3. Are there correlations between property types and other variables?
4. Do the proportions of certain variables change by year?
